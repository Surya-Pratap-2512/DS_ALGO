...
public class MinHeap<T extends Comparable<T>> implements Heap<T>{
    ...
    public MinHeap(final List<T> list) {
        if (list == null) {
    ...
    public MinHeap(final List<T> heap1, final List<T> heap2) {
    ...
    private void shiftUp(int index) {
        ...
        if (isGreater(parentIdx, index) && parentIdx >= 0) {
    ...
    private void shiftDown(int index) {
        ...
        int parentIdx = index;
        if (leftChildIdx < size && isGreater(parentIdx, leftChildIdx)) {
            parentIdx = leftChildIdx;
        }
        if (rightChildIdx < size && isGreater(parentIdx, rightChildIdx)) {
    ...
    private boolean isGreater(int parentIdx, int childIdx) {
